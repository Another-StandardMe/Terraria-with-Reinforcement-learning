...
def _calculate_distance(player_x, player_y, boss_x, boss_y):
    dx = player_x - boss_x
    dy = player_y - boss_y
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if result:
            ...
            dx, dy, distance = _calculate_distance(player_x, player_y, boss_x, boss_y)
            print(f"dx:{abs(dx)}, dy:{abs(dy)}, distance:{distance}")
